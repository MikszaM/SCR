...
proc vTclWindow.top37 {base} {
    ...
    wm geometry $top 600x450+699+262
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    label $top.lab38 \
        -background {#d9d9d9} -foreground {#000000} -text {Data received} 
    vTcl:DefineAlias "$top.lab38" "Label5" vTcl:WidgetProc "Toplevel1" 1
    label $top.lab39 \
        -background {#d9d9d9} -foreground {#000000} -text {Data to send} 
    vTcl:DefineAlias "$top.lab39" "Label6" vTcl:WidgetProc "Toplevel1" 1
    label $top.lab42 \
        -background {#d9d9d9} -foreground {#000000} -relief ridge -text {} \
        -textvariable DataRec 
    vTcl:DefineAlias "$top.lab42" "Label7" vTcl:WidgetProc "Toplevel1" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.rad38 \
        -in $top -x 320 -y 80 -anchor nw -bordermode ignore 
    place $top.rad39 \
        -in $top -x 320 -y 130 -anchor nw -bordermode ignore 
    place $top.rad40 \
        -in $top -x 320 -y 180 -width 54 -relwidth 0 -height 21 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.rad41 \
        -in $top -x 320 -y 230 -anchor nw -bordermode ignore 
    place $top.but42 \
        -in $top -x 460 -y 90 -width 77 -relwidth 0 -height 37 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.ent44 \
        -in $top -x 120 -y 80 -anchor nw -bordermode ignore 
    place $top.lab45 \
        -in $top -x 110 -y 150 -anchor nw -bordermode ignore 
    place $top.lab46 \
        -in $top -x 110 -y 180 -anchor nw -bordermode ignore 
    place $top.lab47 \
        -in $top -x 20 -y 150 -anchor nw -bordermode ignore 
    place $top.lab48 \
        -in $top -x 330 -y 290 -anchor nw -bordermode ignore 
    place $top.lab38 \
        -in $top -x 10 -y 240 -anchor nw -bordermode ignore 
    place $top.lab39 \
        -in $top -x 30 -y 80 -anchor nw -bordermode ignore 
    place $top.lab42 \
        -in $top -x 130 -y 240 -width 106 -relwidth 0 -height 29 -relheight 0 \
        -anchor nw -bordermode ignore 
