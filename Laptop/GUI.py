...
class SCR:
    def __init__(self, top=None):
        ...
        self.Label1.place(relx=0.24, rely=0.27, height=19, width=145)
        ...
        self.Label1_1.place(relx=0.24, rely=0.4, height=19, width=156)
        self.Label1_1.configure(activebackground="#f9f9f9")
        self.Label1_1.configure(text='''[1,2,0-both] [on,off]''')
